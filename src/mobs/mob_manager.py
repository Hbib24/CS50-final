import random
import pygame
from src.attacks.proximity_attack import ProximityAttack
from src.event_manager import Event
from src.mobs.basic_mob import BasicMob
from src.mobs.special_mob import SpecialMob
...
class MobManager:
    ...
    def update(self, game):
        ...
        min_interval = 1000
        max_interval = 3000
        special_min_interval = 30000
        special_max_interval = 50000
        if game._player.level > 5:
            ...
            min_interval = 500
            max_interval = 1000
            special_min_interval = 10000
            special_max_interval = 20000
        ...
        if timer >= self.next_special_spawn_time:
            ...
            self.next_special_spawn_time = timer + random.randint(special_min_interval, special_max_interval)
